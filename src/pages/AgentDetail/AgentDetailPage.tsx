...
const mockAgentData: Record<string, {
  ...
  '1': {
    ...
    author: { name: '阿里云', avatar: '/img/ScreenShot_2026-04-07_175930_033.png', usage: 12580 },
    tags: ['客服', '自动化', 'AI'],
    color: '#1677ff',
  ...
  '2': {
    ...
    avatar: '/img/ScreenShot_2026-04-07_175937_566.png',
    author: { name: '腾讯云', avatar: '/img/ScreenShot_2026-04-07_180223_916.png', usage: 8932 },
    tags: ['数据分析', '可视化', '报表'],
    color: '#52c41a',
    ...
    return (
      <div className={styles.page}>
        <div className={styles.panel}>
          <div className={styles.agentDetailPage}>
